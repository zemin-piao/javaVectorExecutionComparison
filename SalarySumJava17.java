...
public class SalarySumJava17 {
    ...
    public static double sumSalariesVector(float[] salaries) {
        ...
        // Process arrays in chunks using Vector API
        int i = 0;
