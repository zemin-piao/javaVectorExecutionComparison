...
/**
 * JMH Vector API Implementation Benchmark - Requires Java 17+
 *
 * SIMD implementations using Vector API with JMH framework for precise benchmarking.
 * Includes both simple and loop-unrolled implementations.
 * Run: java --add-modules jdk.incubator.vector -jar target/jmh-benchmarks.jar VectorBenchmarkJMH
 */
...
@Fork(1)
public class VectorBenchmarkJMH {
    ...
    @Setup(Level.Trial)
    public void setup() {
        System.out.println("=== JMH Vector API Benchmark Setup ===");
